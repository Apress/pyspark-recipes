...
# Chapter 7
# Recipe 7-6 : Execute a PySpark script using the Standalone cluster manager and the Mesos cluster manager.
# Run following PySpark code lines, line by line in PySpark shell

# Starting Standalone cluster 
#/allPySpark/spark/sbin/start-all.sh 

# Run on standalone by  spark-submit --master spark://localhost.localdomain:7077 --num-executors 2 innerJoinInPySpark.py 
